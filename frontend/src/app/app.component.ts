...
export class CogicApp {
    ...
    constructor(private _app: App, private events: Events, private globals: Globals, private session: SessionProvider, platform: Platform, private config: Config, public instrumentData: InstrumentProvider) {
