...
var competencies = [
		...
		children: [
			{
				...
				val: 3,
				description: 'The nurse should be able to: <ul><li>Identify the patient</li><li>Introduce self to patient and explain their role</li></ul>'
			},
			{
				id: 2,
			...
			},
			{
				...
				tags: ['Initial Patient Contact'],
				val: 3,
				description: 'For ward based nurses, the main focus for obtaining patient consent is for using safe and/or removing unsafe Patient’s Own Drugs. This should follow the local process. As nurses develop new roles and provide additional services they will require a greater understanding of the issues surrounding consent.'
			},
			{
				id: 4,
			...
			},
			{
				...
				tags: ['Initial Patient Contact'],
				val: 3,
				description: 'It is important patient\’s do not receive medicines they allergic to, nor be exposed to products that contain substances they are allergic to eg latex or nuts (some topical preparations contain nut oils). A nurse should:  <ul><li>Ensure that any allergy identified, including the type of reaction, is documented according to local procedure </li><li>Review the prescription to ensure that no culprit medicines have been prescribed.</li><li>Refer any patients who are prescribed medicines to which they have a documented allergy according to local procedure.</li></ul>  nurses should also be aware some patients describe diarrhoea with antibiotics as being allergic to them. '
			},
			{
				id: 7,
	...
	{
		id: 299, number: '2.0', text: 'Medical Law and Ethics', val: Math.floor((Math.random() * 5)), progress: 22,
		children: [
			{
				id: 300,
				...
				tags: ['Law'],
				val: 3,
				description: 'The member is familiar with medical laws and regulations, especially as they pertain to nurse responsibilities.'
			},
			{
				id: 301,
		...
		children: [
			{
				...
				val: 3,
				description: 'The nurse should be able to prioritise their own work and adjust priorities in response to changing circumstances; for example, knowing which patients/tasks take priority. We recognise that it is not possible or necessary to review the pharmaceutical care of every patient, every day. '
			},
			{
				id: 201,
				text: 'Punctuality',
				...
				tags: ['Organization', 'core'],
				val: 3,
				description: 'The nurse should ensure satisfactory completion of tasks with appropriate handover and recognise the importance of punctuality and attention to detail.'
			},
			{
				id: 202,
				text: 'Initiative',
				...
				tags: ['Organization', 'core'],
				val: 3,
				description: 'The nurse should demonstrate initiative in solving a problem or taking on a new opportunity/task without the prompting from others, and demonstrate the ability to work independently within their limitations.'
			},
			{
				id: 203,
				text: 'Efficiency',
				...
				tags: ['Organization', 'core'],
				val: 3,
				description: 'This section deals with time management, and the nurse should demonstrate efficient use of their time. An example could be reviewing the allocatedpatients in the given time to an appropriate standard.'
			},
			{
				id: 204,
