...
/Library/Ruby/Gems/2.0.0/gems/sass-3.4.13/lib/sass/scss/static_parser.rb:21:in `parse_selector'
...
body:before {
  ...
  content: "Error: Invalid CSS after \"foo \": expected selector, was \"3 baz\"\A         on line 1 of input.scss\A \A 1: foo #{1 + 2} baz {a: b}"; }
