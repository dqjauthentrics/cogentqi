...
body:before {
  ...
  content: "Error: Invalid CSS after \"\": expected selector, was \"\"fudge\" 123\"\A         on line 1 of input.scss\A \A 1: \"fudge\" 123 {\A 2:   color: red;\A 3:   + 456 \"mudge\"#foo[hey] {\A 4:     font-weight: bold;\A 5:   }\A 6: }"; }
